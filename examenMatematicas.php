...
if (isset($_SESSION['usuarios'])) {
    ...
    $materiaMatematicas = 3; //Variable para mostrar las preguntas de matematicas
    ...
    $sqlPreguntas->execute(array(':idUsuario' => $idUsuario , ':opcionPregunta' => $opcion_pregunta , ':materia' => $materiaMatematicas));
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        //recargar la pagina
        header('Refresh: 0.1 ; URL=examenMatematicas.php');
    }

    if($resultadoUsername['roles_id'] == 2){ // Si es estudiante
        require 'views/examenMatematicas.view.php';
