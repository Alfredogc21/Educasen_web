...
if (isset($_SESSION['usuarios'])) {
    ...
    $materiaCienciasNaturales = 5; //Variable para mostrar las preguntas de CienciasNaturales
    ...
    $sqlPreguntas->execute(array(':idUsuario' => $idUsuario , ':opcionPregunta' => $opcion_pregunta , ':materia' => $materiaCienciasNaturales));
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        //recargar la pagina
        header('Refresh: 0.1 ; URL=examenCienciasNaturales.php');
    }

    if($resultadoUsername['roles_id'] == 2){ // Si es estudiante
        require 'views/examenCienciasNaturales.view.php';
