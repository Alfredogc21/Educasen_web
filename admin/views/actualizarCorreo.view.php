        ...
        <div class="contenedor-card">
          <div class="card-registro">
            ...
            <form class="col s12" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" name="actualizar">
              ...
              <fieldset>
                <legend class="tituloCard">Actualizar Correo</legend>
                <p class="contenedor-card__descripcion">Actualiza tu correo Educasen</p>
              ...
              <fieldset class="input-group">
                <div class="input-container">
                  ...
                  <input id="email" type="email" name="correo" class="inputs" minlength="4" required value="<?php echo $correo; ?>">
                </div>
              </fieldset>
