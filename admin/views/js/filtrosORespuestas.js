document.addEventListener('DOMContentLoaded', function () {
    ...
    function filtrarRegistros() {
        ...
        // Recorrer los registros y mostrar solo aquellos que coincidan con el filtro
        registros.forEach(function (registro) {
            const mostrar = registro.querySelector('td:nth-child(2)').textContent.toLowerCase().includes(nombre);
    ...
    const enlacesEditar = document.querySelectorAll('#tablaPreguntas tbody tr td:nth-child(5) a');
    ...
    const campoCompetencia = document.getElementById('preguntas');
    const campoTipo = document.getElementById('validacionRespuesta');
