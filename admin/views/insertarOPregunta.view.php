...
<head>
    ...
    <title>Opciones de respuesta</title>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="layout-page">
                        ...
                        <form class="formulario" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                            <fieldset>
                                ...
                                <figure class="fondoLading">
                                    <lottie-player src="views/imagenes/lottiefiles/Animation-answer.json" class="lottieWidth" background="transparent" speed="1" loop autoplay></lottie-player>
                                </figure>
                            </fieldset>
                            ...
                            <fieldset class="contenedor-card__fieldset">
                                ...
                                <div id="options" class="question__options">
                                    <div class="option">
                                        <input type="text" class="option__input" name="option[]" placeholder="Opción A">
                                        <select class="option__select" name="validation[]" required>
                                            <option value="" disabled selected>Seleccione si es correcta o incorrecta</option>
                                            <option value="1">Correcto</option>
                                            <option value="2">Incorrecto</option>
                                        </select>
                                        <button type="button" class="option__remove">Eliminar</button>
                                    </div>
                                </div>

                                <div class="boton-container">
                                    <button id="add-option" type="button" class="question__add-option">Agregar otra opción de respuesta</button>
                                    <input class="submit menu-icono" type="submit" value="Guardar">
                                </div>
                            </fieldset>
                        </form>
                ...
                <!-- JavaScript de la pagina de opcion respuesta -->
                <script src="views/js/opRespuesta.js"></script>
                <!--reCaptchat-->
