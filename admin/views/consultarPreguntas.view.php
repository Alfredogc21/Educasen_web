...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <section class="contenedor-card">
                    <div class="card-registro">
                        <div class="filters">
                            <label for="filtroNombre">Pregunta:</label>
                            ...
                            <label for="tipoPregunta">Tipo pregunta</label>
                        ...
                        <table class="titulosTabla" id="tablaPreguntas">
                            ...
                            <tbody>
                                <?php foreach ($sqlPreguntasPaginados as $preguntas) : ?>
                                    <tr>
                                        <td><?php echo $preguntas['preguntas']; ?></td>
                                        <td><?php echo $preguntas['competencias']; ?></td>
                                        <td><?php echo $preguntas['tipo_pregunta']; ?></td>
                                        <td><a href="#" class="editar-estudiante" data-id="<?php echo $preguntas['id']; ?>"><i class="menu-icon tf-icons bx bx-edit"></i></a></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
            ...
            <script src="views/js/filtrosPreguntas.js"></script>
