...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <section class="contenedor-card">
                    <div class="card-registro">
                        <div class="filters">
                            <label for="filtroNombre">Opcion de respuesta</label>
                            <input type="text" id="filtroNombre" name="filtroNombre" placeholder="Buscar por opcion de respuesta">

                        </div>
                        <div class="ocultarInput" id="datos-usuario" data-id-usuario-logueado="<?php echo $infoCorreo['id']; ?>"></div>

                        <!-- Tabla HTML -->
                        <table class="titulosTabla" id="tablaPreguntas">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($sqlORespuestasPaginadas as $ORespuesta) : ?>
                                    <tr>
                                        <td><?php echo $ORespuesta['contenido']; ?></td>
                                        <td><?php echo $ORespuesta['preguntas']; ?></td>
                                        <td><?php echo $ORespuesta['validacion']; ?></td>
                                        <td><?php echo $ORespuesta['tipo_contenido']; ?></td>
                                        <td><a href="#" class="editar-estudiante" data-id="<?php echo $ORespuesta['id']; ?>"><i class="menu-icon tf-icons bx bx-edit"></i></a></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
            ...
            <div id="modalEditar" class="modal">
                <div class="modal-contenido">
                    ...
                    <form id="formularioEditar" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" name="actualizar">
                        ...
                        <label for="nombre">Opcion de respuesta</label>
                        <input type="text" id="nombre" name="nombre" required>

                        <label for="preguntas">Seleccione la pregunta correspondiente</label>
                        ...
                        <label for="validacionRespuesta">Validacion pregunta</label>
                        <select id="validacionRespuesta" name="validacionRespuesta">
                            <option value="" disabled selected>Seleccione correcto o incorrecto</option>
                            <?php
                            foreach ($tipoValidaciones as $validacion) {
                                echo '<option value="' . $validacion['id'] . '">' . $validacion['nombre'] . '</option>';
                            }
                            ?>
                        </select>
            ...
            <script src="views/js/filtrosORespuestas.js"></script>
