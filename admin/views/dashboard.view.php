        ...
        <ul class="menu-inner py-1">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="#" class="menu-link">
                  <div data-i18n="Account">Personas</div>
                </a>
              </li>
              <li class="menu-item">
          ...
          <li class="menu-item">
            <a href="#" class="menu-link menu-toggle">
              ...
              <div data-i18n="Authentications">Consultar</div>
            </a>
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="#" class="menu-link" target="_blank">
                  <div data-i18n="Basic">Administradores</div>
                </a>
              </li>
              <li class="menu-item">
              ...
              <li class="menu-item">
                <a href="#" class="menu-link" target="_blank">
                  <div data-i18n="Basic">Docentes</div>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="menu-item">
            <a href="#" class="menu-link">
              ...
              <div data-i18n="Basic">Agregar preguntas</div>
            </a>
          </li>
