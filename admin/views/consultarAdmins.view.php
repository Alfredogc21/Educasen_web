...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
                ...
                <section class="contenedor-card">
                    <div class="card-registro">
                        ...
                        <table class="titulosTabla" id="tablaAdministradores">
                            ...
                            <tbody>
                                <?php foreach ($sqlAdministradoresPaginados as $administrador) : ?>
                                    <tr>
                                        <td><?php echo $administrador['Nombre']; ?></td>
                                        <td><?php echo $administrador['fecha_registro']; ?></td>
                                        <td><?php echo $administrador['estados']; ?></td>
                                        <td><?php echo $administrador['email']; ?></td>
                                        <td><a href="#" class="editar-estudiante" data-id="<?php echo $administrador['id']; ?>"><i class="menu-icon tf-icons bx bx-edit"></i></a></td>
                                        <td><a href="#" class="eliminar-estudiante" data-id="<?php echo $administrador['id']; ?>"><i class="menu-icon tf-icons bx bx-trash"></i></a></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
            ...
            <script src="views/js/filtrosAdmin.js"></script>
